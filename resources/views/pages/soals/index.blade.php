            ...
            <div class="section-header">
                ...
                <div class="section-header-button">
                    <a href="{{ route('soal.create') }}"
                        class="btn btn-primary">Add New Soal</a>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <form action="{{ route('soal.destroy', $soal->id) }}" method="POST" class="ml-2">
                                                        <input type="hidden" name="_method" value="DELETE">
                                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                        <button class="btn btn-sm btn-danger btn-icon" onclick="return confirmDelete({{ $soal->id }})">
